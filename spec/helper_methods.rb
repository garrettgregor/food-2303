    ...
    :foodNutrients=>
     [{:nutrientId=>1003,
      ...
      {:nutrientId=>1258,
       ...
       :rank=>9700,
       :indentLevel=>1,
       :foodNutrientId=>11594961,
       :percentDailyValue=>0}],
    :finalFoodInputFoods=>[],
    :foodMeasures=>[],
    :foodAttributes=>[],
    :foodAttributeTypes=>[{:name=>"Update Log", :description=>"Changes that were made to this food", :id=>998, :foodAttributes=>[{:value=>"5", :name=>"Nutrient Added", :id=>807441}, {:value=>"4", :name=>"Nutrient Updated", :id=>807439}]}],
    :foodVersionIds=>[]}
end